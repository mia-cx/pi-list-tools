...
const modelCases = [
	...
	},
	{
		...
		expected:
			"You're currently running as Anthropic Claude 3.5 Haiku <noreply@anthropic.com>, with the id \"anthropic/claude-3-5-haiku-20241022\".",
	},
	{
	...
	},
	{
		...
		expected:
			"You're currently running as Anthropic Claude 3.5 Sonnet <noreply@anthropic.com>, with the id \"anthropic/claude-3-5-sonnet-20240620\".",
	},
	{
		...
		modelLabel: "Claude 3.5 Sonnet",
		expected:
			"You're currently running as Anthropic Claude 3.5 Sonnet <noreply@anthropic.com>, with the id \"anthropic/claude-3-5-sonnet-20241022\".",
	},
	{
		...
		expected:
			"You're currently running as Anthropic Claude 3.7 Sonnet <noreply@anthropic.com>, with the id \"anthropic/claude-3-7-sonnet-20250219\".",
	},
	{
		...
		expected:
			"You're currently running as Anthropic Claude 3 Haiku <noreply@anthropic.com>, with the id \"anthropic/claude-3-haiku-20240307\".",
	},
	{
		...
		expected:
			"You're currently running as Anthropic Claude 3 Opus <noreply@anthropic.com>, with the id \"anthropic/claude-3-opus-20240229\".",
	},
	{
	...
	},
	{
		...
		expected:
			"You're currently running as Anthropic Claude Haiku 4.5 <noreply@anthropic.com>, with the id \"anthropic/claude-haiku-4-5-20251001\".",
	},
	{
	...
	},
	{
		...
		modelLabel: "Claude Opus 4.1",
		expected:
			"You're currently running as Anthropic Claude Opus 4.1 <noreply@anthropic.com>, with the id \"anthropic/claude-opus-4-1-20250805\".",
	},
	{
		...
		expected:
			"You're currently running as Anthropic Claude Opus 4 <noreply@anthropic.com>, with the id \"anthropic/claude-opus-4-20250514\".",
	},
	{
	...
	},
	{
		...
		modelLabel: "Claude Opus 4.5",
		expected:
			"You're currently running as Anthropic Claude Opus 4.5 <noreply@anthropic.com>, with the id \"anthropic/claude-opus-4-5-20251101\".",
	},
	{
	...
	},
	{
		...
		expected:
			"You're currently running as Anthropic Claude Sonnet 4 <noreply@anthropic.com>, with the id \"anthropic/claude-sonnet-4-20250514\".",
	},
	{
	...
	},
	{
		...
		modelLabel: "Claude Sonnet 4.5",
		expected:
			"You're currently running as Anthropic Claude Sonnet 4.5 <noreply@anthropic.com>, with the id \"anthropic/claude-sonnet-4-5-20250929\".",
	},
] as const;
